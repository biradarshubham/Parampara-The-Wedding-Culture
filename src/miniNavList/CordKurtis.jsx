...
import Cord from '../Apis/CordKurtis.json'
...
const CordKurtis = () => {
  ...
  function cart(id) {
    const product = Cord.cordKurtis.find(item => item.id === id);
    if (product) {
      addToCart(product);
    }
  }
  ...
  return (
    ...
    <h1 className="card-h1"> Beautiful cord kurtis Collection 👗</h1>
